...
class AddressesResourceIT {
     ...
     *
     * @see gr.adr.hermes.repository.search.AddressesSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchAddresses() throws Exception {
        ...
        // Initialize the database
        addressesRepository.saveAndFlush(addresses);
        when(mockAddressesSearchRepository.search("id:" + addresses.getId(), PageRequest.of(0, 20)))
