...
class JobsResourceIT {
     ...
     *
     * @see gr.adr.hermes.repository.search.JobsSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void createJobs() throws Exception {
        ...
        verify(mockJobsSearchRepository, times(1)).save(testJobs);
    }
    ...
    void createJobsWithExistingId() throws Exception {
        ...
        // Validate the Jobs in Elasticsearch
        verify(mockJobsSearchRepository, times(0)).save(jobs);
    }
    ...
    void putNewJobs() throws Exception {
        ...
        // Validate the Jobs in Elasticsearch
        verify(mockJobsSearchRepository).save(testJobs);
    }
    ...
    void deleteJobs() throws Exception {
        ...
        // Validate the Jobs in Elasticsearch
        verify(mockJobsSearchRepository, times(1)).deleteById(jobs.getId());
    }
    ...
    void searchJobs() throws Exception {
        ...
        // Initialize the database
        jobsRepository.saveAndFlush(jobs);
        when(mockJobsSearchRepository.search("id:" + jobs.getId(), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(jobs), PageRequest.of(0, 1), 1));
