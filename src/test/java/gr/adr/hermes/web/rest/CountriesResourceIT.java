...
class CountriesResourceIT {
     ...
     *
     * @see gr.adr.hermes.repository.search.CountriesSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void putNewCountries() throws Exception {
        ...
        // Validate the Countries in Elasticsearch
        verify(mockCountriesSearchRepository).save(testCountries);
    }
    ...
    void searchCountries() throws Exception {
        ...
        // Initialize the database
        countriesRepository.saveAndFlush(countries);
        when(mockCountriesSearchRepository.search("id:" + countries.getId(), PageRequest.of(0, 20)))
