<template>
  <div>
    <h2 id="page-heading" data-cy="CitiesHeading">
      <span v-text="$t('hermesvueApp.cities.home.title')" id="cities-heading">Cities</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('hermesvueApp.cities.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'CitiesCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('hermesvueApp.cities.home.createLabel')"> Create a new Cities </span>
          </button>
        </router-link>
      </div>
    </h2>
        ...
        <form name="searchForm" class="form-inline" v-on:submit.prevent="search(currentSearch)">
          <div class="input-group w-100 mt-3">
            <input
              ...
              name="currentSearch"
              id="currentSearch"
              v-bind:placeholder="$t('hermesvueApp.cities.home.search')"
    ...
    <div class="alert alert-warning" v-if="!isFetching && cities && cities.length === 0">
      <span v-text="$t('hermesvueApp.cities.home.notFound')">No cities found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('name')">
              <span v-text="$t('hermesvueApp.cities.name')">Name</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('president')">
              <span v-text="$t('hermesvueApp.cities.president')">President</span>
            ...
            <th scope="row" v-on:click="changeOrder('presidentsPhone')">
              <span v-text="$t('hermesvueApp.cities.presidentsPhone')">Presidents Phone</span>
            ...
            <th scope="row" v-on:click="changeOrder('secretary')">
              <span v-text="$t('hermesvueApp.cities.secretary')">Secretary</span>
            ...
            <th scope="row" v-on:click="changeOrder('secretarysPhone')">
              <span v-text="$t('hermesvueApp.cities.secretarysPhone')">Secretarys Phone</span>
            ...
            <th scope="row" v-on:click="changeOrder('police')">
              <span v-text="$t('hermesvueApp.cities.police')">Police</span>
            ...
            <th scope="row" v-on:click="changeOrder('policesPhone')">
              <span v-text="$t('hermesvueApp.cities.policesPhone')">Polices Phone</span>
            ...
            <th scope="row" v-on:click="changeOrder('doctor')">
              <span v-text="$t('hermesvueApp.cities.doctor')">Doctor</span>
            ...
            <th scope="row" v-on:click="changeOrder('doctorsPhone')">
              <span v-text="$t('hermesvueApp.cities.doctorsPhone')">Doctors Phone</span>
            ...
            <th scope="row" v-on:click="changeOrder('teacher')">
              <span v-text="$t('hermesvueApp.cities.teacher')">Teacher</span>
            ...
            <th scope="row" v-on:click="changeOrder('teachersPhone')">
              <span v-text="$t('hermesvueApp.cities.teachersPhone')">Teachers Phone</span>
            ...
            <th scope="row" v-on:click="changeOrder('priest')">
              <span v-text="$t('hermesvueApp.cities.priest')">Priest</span>
            ...
            <th scope="row" v-on:click="changeOrder('priestsPhone')">
              <span v-text="$t('hermesvueApp.cities.priestsPhone')">Priests Phone</span>
            ...
            <th scope="row" v-on:click="changeOrder('country.name')">
              <span v-text="$t('hermesvueApp.cities.country')">Country</span>
            ...
            <th scope="row" v-on:click="changeOrder('region.name')">
              <span v-text="$t('hermesvueApp.cities.region')">Region</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="hermesvueApp.cities.delete.question" data-cy="citiesDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-cities-heading" v-text="$t('hermesvueApp.cities.delete.question', { id: removeId })">
