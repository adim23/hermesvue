<template>
  <div>
    <h2 id="page-heading" data-cy="CitizensHeading">
      <span v-text="$t('hermesvueApp.citizens.home.title')" id="citizens-heading">Citizens</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('hermesvueApp.citizens.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'CitizensCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('hermesvueApp.citizens.home.createLabel')"> Create a new Citizens </span>
          </button>
        </router-link>
      </div>
    </h2>
        ...
        <form name="searchForm" class="form-inline" v-on:submit.prevent="search(currentSearch)">
          <div class="input-group w-100 mt-3">
            <input
              ...
              name="currentSearch"
              id="currentSearch"
              v-bind:placeholder="$t('hermesvueApp.citizens.home.search')"
    ...
    <div class="alert alert-warning" v-if="!isFetching && citizens && citizens.length === 0">
      <span v-text="$t('hermesvueApp.citizens.home.notFound')">No citizens found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('title')">
              <span v-text="$t('hermesvueApp.citizens.title')">Title</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'title'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('lastname')">
              <span v-text="$t('hermesvueApp.citizens.lastname')">Lastname</span>
            ...
            <th scope="row" v-on:click="changeOrder('firstname')">
              <span v-text="$t('hermesvueApp.citizens.firstname')">Firstname</span>
            ...
            <th scope="row" v-on:click="changeOrder('fathersName')">
              <span v-text="$t('hermesvueApp.citizens.fathersName')">Fathers Name</span>
            ...
            <th scope="row" v-on:click="changeOrder('comments')">
              <span v-text="$t('hermesvueApp.citizens.comments')">Comments</span>
            ...
            <th scope="row" v-on:click="changeOrder('birthDate')">
              <span v-text="$t('hermesvueApp.citizens.birthDate')">Birth Date</span>
            ...
            <th scope="row" v-on:click="changeOrder('giortazi')">
              <span v-text="$t('hermesvueApp.citizens.giortazi')">Giortazi</span>
            ...
            <th scope="row" v-on:click="changeOrder('male')">
              <span v-text="$t('hermesvueApp.citizens.male')">Male</span>
            ...
            <th scope="row" v-on:click="changeOrder('meLetter')">
              <span v-text="$t('hermesvueApp.citizens.meLetter')">Me Letter</span>
            ...
            <th scope="row" v-on:click="changeOrder('meLabel')">
              <span v-text="$t('hermesvueApp.citizens.meLabel')">Me Label</span>
            ...
            <th scope="row" v-on:click="changeOrder('image')">
              <span v-text="$t('hermesvueApp.citizens.image')">Image</span>
            ...
            <th scope="row" v-on:click="changeOrder('folder.name')">
              <span v-text="$t('hermesvueApp.citizens.folder')">Folder</span>
            ...
            <th scope="row" v-on:click="changeOrder('company.name')">
              <span v-text="$t('hermesvueApp.citizens.company')">Company</span>
            ...
            <th scope="row" v-on:click="changeOrder('maritalStatus.name')">
              <span v-text="$t('hermesvueApp.citizens.maritalStatus')">Marital Status</span>
            ...
            <th scope="row" v-on:click="changeOrder('team.name')">
              <span v-text="$t('hermesvueApp.citizens.team')">Team</span>
            ...
            <th scope="row" v-on:click="changeOrder('code.name')">
              <span v-text="$t('hermesvueApp.citizens.code')">Code</span>
            ...
            <th scope="row" v-on:click="changeOrder('origin.name')">
              <span v-text="$t('hermesvueApp.citizens.origin')">Origin</span>
            ...
            <th scope="row" v-on:click="changeOrder('job.name')">
              <span v-text="$t('hermesvueApp.citizens.job')">Job</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="hermesvueApp.citizens.delete.question" data-cy="citizensDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-citizens-heading" v-text="$t('hermesvueApp.citizens.delete.question', { id: removeId })">
