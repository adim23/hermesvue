  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="hermesvueApp.regions.home.createOrEditLabel"
          data-cy="RegionsCreateUpdateHeading"
          v-text="$t('hermesvueApp.regions.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.regions.name')" for="regions-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.regions.country')" for="regions-country">Country</label>
