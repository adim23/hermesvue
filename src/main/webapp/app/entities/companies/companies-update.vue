  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="hermesvueApp.companies.home.createOrEditLabel"
          data-cy="CompaniesCreateUpdateHeading"
          v-text="$t('hermesvueApp.companies.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.companies.name')" for="companies-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.companies.kind')" for="companies-kind">Kind</label>
