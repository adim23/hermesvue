  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="hermesvueApp.citizensMeetings.home.createOrEditLabel"
          data-cy="CitizensMeetingsCreateUpdateHeading"
          v-text="$t('hermesvueApp.citizensMeetings.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.citizensMeetings.meetDate')" for="citizens-meetings-meetDate"
              >Meet Date</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.citizensMeetings.agenda')" for="citizens-meetings-agenda"
              >Agenda</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.citizensMeetings.comments')" for="citizens-meetings-comments"
              >Comments</label
            >
            <textarea
              class="form-control"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.citizensMeetings.amount')" for="citizens-meetings-amount"
              >Amount</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.citizensMeetings.quantity')" for="citizens-meetings-quantity"
              >Quantity</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.citizensMeetings.status')" for="citizens-meetings-status"
              >Status</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.citizensMeetings.flag')" for="citizens-meetings-flag">Flag</label>
            <input
              type="checkbox"
              class="form-check"
              name="flag"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('hermesvueApp.citizensMeetings.citizen')" for="citizens-meetings-citizen"
              >Citizen</label
            >
