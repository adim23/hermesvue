<template>
  <div>
    <h2 id="page-heading" data-cy="AddressesHeading">
      <span v-text="$t('hermesvueApp.addresses.home.title')" id="addresses-heading">Addresses</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('hermesvueApp.addresses.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'AddressesCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('hermesvueApp.addresses.home.createLabel')"> Create a new Addresses </span>
          </button>
        </router-link>
      </div>
    </h2>
        ...
        <form name="searchForm" class="form-inline" v-on:submit.prevent="search(currentSearch)">
          <div class="input-group w-100 mt-3">
            <input
              ...
              name="currentSearch"
              id="currentSearch"
              v-bind:placeholder="$t('hermesvueApp.addresses.home.search')"
    ...
    <div class="alert alert-warning" v-if="!isFetching && addresses && addresses.length === 0">
      <span v-text="$t('hermesvueApp.addresses.home.notFound')">No addresses found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('address')">
              <span v-text="$t('hermesvueApp.addresses.address')">Address</span>
            ...
            <th scope="row" v-on:click="changeOrder('addressNo')">
              <span v-text="$t('hermesvueApp.addresses.addressNo')">Address No</span>
            ...
            <th scope="row" v-on:click="changeOrder('zipCode')">
              <span v-text="$t('hermesvueApp.addresses.zipCode')">Zip Code</span>
            ...
            <th scope="row" v-on:click="changeOrder('prosfLetter')">
              <span v-text="$t('hermesvueApp.addresses.prosfLetter')">Prosf Letter</span>
            ...
            <th scope="row" v-on:click="changeOrder('nameLetter')">
              <span v-text="$t('hermesvueApp.addresses.nameLetter')">Name Letter</span>
            ...
            <th scope="row" v-on:click="changeOrder('letterClose')">
              <span v-text="$t('hermesvueApp.addresses.letterClose')">Letter Close</span>
            ...
            <th scope="row" v-on:click="changeOrder('firstLabel')">
              <span v-text="$t('hermesvueApp.addresses.firstLabel')">First Label</span>
            ...
            <th scope="row" v-on:click="changeOrder('secondLabel')">
              <span v-text="$t('hermesvueApp.addresses.secondLabel')">Second Label</span>
            ...
            <th scope="row" v-on:click="changeOrder('thirdLabel')">
              <span v-text="$t('hermesvueApp.addresses.thirdLabel')">Third Label</span>
            ...
            <th scope="row" v-on:click="changeOrder('fourthLabel')">
              <span v-text="$t('hermesvueApp.addresses.fourthLabel')">Fourth Label</span>
            ...
            <th scope="row" v-on:click="changeOrder('fifthLabel')">
              <span v-text="$t('hermesvueApp.addresses.fifthLabel')">Fifth Label</span>
            ...
            <th scope="row" v-on:click="changeOrder('favourite')">
              <span v-text="$t('hermesvueApp.addresses.favourite')">Favourite</span>
            ...
            <th scope="row" v-on:click="changeOrder('country.name')">
              <span v-text="$t('hermesvueApp.addresses.country')">Country</span>
            ...
            <th scope="row" v-on:click="changeOrder('kind.name')">
              <span v-text="$t('hermesvueApp.addresses.kind')">Kind</span>
            ...
            <th scope="row" v-on:click="changeOrder('region.name')">
              <span v-text="$t('hermesvueApp.addresses.region')">Region</span>
            ...
            <th scope="row" v-on:click="changeOrder('company.name')">
              <span v-text="$t('hermesvueApp.addresses.company')">Company</span>
            ...
            <th scope="row" v-on:click="changeOrder('citizen.id')">
              <span v-text="$t('hermesvueApp.addresses.citizen')">Citizen</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="hermesvueApp.addresses.delete.question" data-cy="addressesDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-addresses-heading" v-text="$t('hermesvueApp.addresses.delete.question', { id: removeId })">
