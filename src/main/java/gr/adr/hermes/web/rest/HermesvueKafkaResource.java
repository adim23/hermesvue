...
@RestController
@RequestMapping("/api/hermesvue-kafka")
public class HermesvueKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HermesvueKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HermesvueKafkaResource(KafkaProperties kafkaProperties) {
