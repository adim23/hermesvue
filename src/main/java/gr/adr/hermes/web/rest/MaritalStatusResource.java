...
public class MaritalStatusResource {
    ...
    /**
     * {@code SEARCH  /_search/marital-statuses?query=:query} : search for the maritalStatus corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<MaritalStatus>> searchMaritalStatuses(
